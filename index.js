...
describe('TaskLister', function () {
  ...
  beforeEach(function () {
    // Set up the virtual DOM using JSDOM
    window = new JSDOM(`
      <!DOCTYPE html>
      <html>
        <body>
    ...
    // Assign document from JSDOM's window object
    document = window.document;

    // Access elements after the DOM is fully loaded
    taskForm = document.getElementById('create-task-form');
    taskInput = document.getElementById('new-task-description');
    taskList = document.getElementById('task-list');

    // Append the actual script (your real index.js file) to the DOM
